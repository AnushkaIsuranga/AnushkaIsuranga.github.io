...
export default function Contact() {
  ...
  return (
    <section id="contact" className="section-shell pb-16" aria-labelledby="contact-title">
            ...
            <div className="space-y-5">
              <Reveal>
                <div className="stat-card">
                  ...
                  <p className="mt-4 text-lg font-semibold text-white">{siteContent.contact.bestFitText}</p>
                </div>
              </Reveal>
              ...
              <MobileParallax offset={48} scale={1.12}>
                <div className="editorial-card rounded-[2rem] p-6 sm:p-8">
                  <div className="mb-6">
                    ...
                    <p className="mt-3 text-sm leading-7 text-slate-400">{siteContent.contact.form.copy}</p>
                  </div>
